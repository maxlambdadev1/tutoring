    ...
    function i(e, t) {
        return r(e) || function(e, t) {
            var i = []
              ...
              , n = void 0;
            try {
                for (var o, c = e[Symbol.iterator](); !(r = (o = c.next()).done) && (i.push(o.value),
                !t || i.length !== t); r = !0)
                    ;
            } catch (e) {
                a = !0,
    ...
    var n = function(e, t) {
      ...
      , E = function(e, t, i, r, a) {
        "path" !== t && (e.rect = function(e, t) {
            ...
            return u(a) || (a = u(o) && u(s) ? t.height - o - s : s),
      ...
      , w = function(e) {
        var t = i(e, 2)
          ...
          , n = a.points ? {} : v.reduce(function(e, t) {
            var i;
            return e[t] = "string" == typeof (i = a[t]) && /%/.test(i) ? parseFloat(i) / 100 : i,
            e
        }, {});
                    ...
                    if (n) {
                        ...
                        if (!y || y && p) {
                            ...
                            if ("force" === g)
                                ...
                                "cover" === g ? v = Math.max(I, M) : "contain" === g && (v = Math.min(I, M)),
                                h *= v,
                                u *= v
                        }
                    }
        ...
        return e.utils.createView({
            ...
            create: function(t) {
                ...
                i.ref.image = i.appendChildView(i.createChildView(function(e) {
                    return e.utils.createView({
                        ...
                        create: function(t) {
                            ...
                            i.ref.bitmap = i.appendChildView(i.createChildView(function(e) {
                                return e.utils.createView({
                                    name: "image-bitmap",
                                    ignoreRect: !0,
                                    mixins: {
                ...
                i.ref.destroyMarkup = function() {
                    i.ref.markup && (i.removeChildView(i.ref.markup),
                    i.ref.markup = null)
                }
                ;
            ...
            write: function(e) {
                ...
                t.ref.markup.crop = C(l, a)) : t.ref.markup && t.ref.destroyMarkup();
                var v = t.ref.image;
                if (r)
                    return v.originX = null,
                    v.originY = null,
                    v.translateX = null,
                    v.translateY = null,
                    v.rotateZ = null,
      ...
      , q = function(e) {
        var t = e.utils.createView({
            ...
            create: function(e) {
                var t = e.root
                  , i = e.props;
                !V && document.querySelector("base") && (G = G.replace(/url\(\#/g, "url(" + window.location.href.replace(window.location.hash, "") + "#"),
                V = !0),
                O++,
          ...
          , a = function(e, t, i) {
            return new Promise(function(a) {
                ...
                var n = function(e) {
                    ...
                    return t.data.set(new Uint8ClampedArray(e.data)),
                    t
                }(e.ref.imageData);
                if (!t || 20 !== t.length)
                    return i.getContext("2d").putImageData(n, 0, 0),
                    a();
                var o = r(S);
                o.post({
                    imageData: n,
          ...
          , n = function(e) {
            ...
            if (o) {
                ...
                t.query("GET_IMAGE_PREVIEW_MARKUP_SHOW") && (c = o.getMetadata("markup") || [],
        ...
        return e.utils.createView({
            ...
            create: function(e) {
                ...
                i.ref.imageViewBin = [],
                i.ref.overlayShadow = i.appendChildView(i.createChildView(t, {
                    opacity: 0,
                    status: "idle"
                })),
            ...
            write: e.utils.createRoute({
                ...
                DID_FINISH_CALCULATE_PREVIEWSIZE: function(e) {
                    ...
                    if (c) {
                        ...
                        if (s = c.file,
                        !(((h = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)) ? parseInt(h[1]) : null) <= 58) && "createImageBitmap"in window && W(s)) {
                            var f = r(b);
                            f.post({
                                file: c.file
                            }, function(e) {
                                    ...
                                    if (Math.abs(s.aspectRatio - h.crop.aspectRatio) > 1e-5) {
                                        ...
                                        !function(e) {
                                            ...
                                            if (r) {
                                                ...
                                                t.query("GET_IMAGE_PREVIEW_MARKUP_SHOW") && (a.dirty = !0,
        ...
        return t("CREATE_VIEW", function(e) {
            ...
            if (t("file") && r("GET_ALLOW_IMAGE_PREVIEW")) {
                ...
                i.registerWriter(a({
                    ...
                    t.ref.shouldDrawPreview && (requestAnimationFrame(function() {
