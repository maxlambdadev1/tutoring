<div class="container mx-0">
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <div class="other-action">
                        <input type="button" value="Details" data-bs-toggle="modal" data-bs-target="#updateParentDetailModal{{$row->id}}" class="btn btn-info btn-sm w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <livewire:admin.components.edit-parent-modal :parent_id="$row->id" :key="$row->id" />
</div>