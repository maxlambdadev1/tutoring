<div class="container mx-0">
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <div class="other-action">
                        <input type="button" value="Add follow up" data-bs-toggle="modal" data-bs-target="#addFollowupParentModal{{$row->id}}" class="btn btn-outline-info waves-effect waves-light btn-sm w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="addFollowupParentModal{{$row->id}}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-modal="true" role="dialog" x-data="{in_six_weeks{{$row->id}} : true }">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Follow up on this parent</h5>
                ...
                <div class="modal-footer" x-data="{ init() { 
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" 
                        wire:click="parentCheckInAddFollowup({{$row->id}}, in_six_weeks{{$row->id}}, $refs.schedule_date{{$row->id}}.value)"
