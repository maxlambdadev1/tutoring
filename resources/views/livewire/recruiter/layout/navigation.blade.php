...
new class extends Component
{
    ...
    {
        $this->recruiter = auth()->user()->recruiter;
    }
}; ?>
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                ...
                <span class="account-user-avatar"> 
                    <img src="{{asset($recruiter->getPhoto())}}" alt="user-image" class="rounded-circle">
                </span>
                <span>
                    <span class="account-user-name">{{$recruiter->tutor_name}}</span>
                    <span class="account-position">recruiter</span>
                </span>
            </a>
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                <!-- item-->
                <div class=" dropdown-header noti-title">
                    <h6 class="text-overflow m-0">Welcome {{$recruiter->first_name}}!</h6>
                </div>
    ...
    <div class="app-search dropdown d-none d-lg-block">
        ...
        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
            ...
            <div class="notification-list">
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <div class="d-flex">
                        <img class"d-flex me-2 rounded-circle" src="{{asset('template/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="32">
                        <div class="w-100">
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <div class="d-flex">
                        <img class"d-flex me-2 rounded-circle" src="{{asset('template/images/users/avatar-5.jpg')}}" alt="Generic placeholder image" height="32">
                        <div class="w-100">
