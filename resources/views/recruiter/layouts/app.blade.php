...
<body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <!-- LOGO -->
            <a href="{{route('recruiter.dashboard')}}" class="logo text-center logo-light">
                <span class="logo-lg">
            ...
            <!-- LOGO -->
            <a href="{{route('recruiter.dashboard')}}" class="logo text-center logo-dark">
                <span class="logo-lg">
        ...
        <div class="content-page">
            <div class="content">
                <!-- Topbar Start -->
                <livewire:recruiter.layout.navigation>
                    <!-- end Topbar -->
